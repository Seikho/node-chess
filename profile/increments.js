    ...
    boardState.ranks.forEach(function (rank) {
        rank.squares.forEach(function (square) {
            if (square.piece == null)
                return;
            moves = moves.concat(_this.inferMoves(square.piece, boardState));
        });
    });
...
function movePiece(move, boardState) {
    ...
    boardState = deepCopy_1.default(boardState || this.boardState);
    var origin = this.getSquare(from, boardState);
    ...
    if (!pieceMove)
        return null;
    var destination = this.getSquare(to, boardState);
    ...
    movePatternPostActions.forEach(function (func) {
        func.action(destination.piece, boardState, _this);
    });
    var pieceFunctions = destination.piece.postMoveFunctions || [];
    pieceFunctions.forEach(function (fn) { return fn.action(destination.piece, boardState, _this); });
    origin.piece = null;
    ...
    enginePostMoveActions.forEach(function (postMove) {
        if (!postMove.moveNumber || postMove.moveNumber === boardState.moveNumber)
            postMove.action(destination.piece, boardState, _this);
    });
    ...
    if (!saveToBoard)
        return boardState;
    this.postMoveFunctions.forEach(function (moveFn) {
        moveFn.action(destination.piece, boardState, _this);
    });
...
},{"./deepCopy":54}],59:[function(require,module,exports){
"use strict";
function toString() {
    var ranks = [];
    var fileLabels = ['-'];
...
"use strict";
var toString_1 = require('./helpers/toString');
var getMoves_1 = require('./helpers/getMoves');
var inferMoves_1 = require('./helpers/inferMoves');
var movePiece_1 = require('./helpers/movePiece');
var fen_1 = require('./parsers/fen');
var createSquares_1 = require('./helpers/createSquares');
var basePiece_1 = require('./basePiece');
var availableMoves_1 = require('./helpers/availableMoves');
var getSquare_1 = require('./helpers/getSquare');
var createPiece_1 = require('./helpers/createPiece');
/**
...
var Engine = (function () {
    function Engine() {
        ...
        this.pieces = [];
        this.positionParser = fen_1.default.bind(this);
        ...
        this.analyzer = function (uciEngine) {
            _this.uciEngine = uciEngine;
        };
    }
    return Engine;
}());
...
},{"./basePiece":50,"./helpers/availableMoves":51,"./helpers/createPiece":52,"./helpers/createSquares":53,"./helpers/getMoves":55,"./helpers/getSquare":56,"./helpers/inferMoves":57,"./helpers/movePiece":58,"./helpers/toString":59,"./parsers/fen":69}],61:[function(require,module,exports){
"use strict";
...
},{"../../index":60,"./bishop":61,"./king":63,"./knight":64,"./pawn":65,"./queen":66,"./rook":67,"./rules":68}],63:[function(require,module,exports){
"use strict";
...
function oppositeDirection(dir) {
    return dir === enums_1.Direction.QueenSide
        ? enums_1.Direction.KingSide
        : enums_1.Direction.QueenSide;
}
var king = {
    notation: "k",
    name: "King",
...
},{"../../../enums":71}],64:[function(require,module,exports){
"use strict";
...
function createFilesForRank(engine, fenRank, rankNumber) {
    ...
    var fenRankArray = fenRank.split('');
...
},{"./stringParsers/fen":70}],70:[function(require,module,exports){
"use strict";
...
},{"pegjs":48}],71:[function(require,module,exports){
"use strict";
(function (Direction) {
...
var engine_2 = require('./engine/instances/classic/engine');
var enums_1 = require('./enums');
var chess = {
...
},{"./engine":60,"./engine/instances/classic/engine":62,"./enums":71}],73:[function(require,module,exports){
"use strict";
var chess = require("../src/index");
var chai_1 = require('chai');
var make = chess.classic;
...
describe("relatve destination tests", function () {
    it("White: will evaluate {1,0} from {2,2} to be {3,2}", function () {
        var b2 = classic.getSquare({ file: 2, rank: 2 });
        var c2 = b2.piece.getRelativeDestination({ file: 1, rank: 0 });
        chai_1.expect(c2.file).to.equal(3);
        chai_1.expect(c2.rank).to.equal(2);
    });
    it("Black: will evaluate {0,1} from {2,7} to be {2,6}", function () {
        var b7 = classic.getSquare({ file: 2, rank: 7 });
        var b6 = b7.piece.getRelativeDestination({ file: 0, rank: 1 });
        chai_1.expect(b6.file).to.equal(2);
        chai_1.expect(b6.rank).to.equal(6);
    });
});
describe("absolute destination tests", function () {
    it("Black: will evaluate {0,-2} from {2,7} to be {2,5}", function () {
        var b7 = classic.getSquare({ file: 2, rank: 7 });
        var b5 = b7.piece.getAbsoluteDestination({ file: 0, rank: -2 });
        chai_1.expect(b5.file).to.equal(2);
        chai_1.expect(b5.rank).to.equal(5);
    });
});
...
describe("classic movement tests", function () {
    ...
    it("[Promote] will promote pawn on a7 to a queen", function () {
        ...
        chai_1.expect(square.piece.notation).to.equal("q");
    });
});
...
function atLocationTest(message, location, notation) {
    ...
    it(message, function () {
        ...
        chai_1.expect(square.piece.notation).to.equal(notation);
    });
}
function hasMovesTest(message, start, expectedMoves) {
    ...
    it(message, function () {
        ...
        expectedMoves.forEach(function (m) { return chai_1.expect(moves).to.include({ rank: m.rank, file: m.file }); });
...
function pieceMoveTest(message, from, to, wont) {
    ...
    it(message, function () {
        ...
        chai_1.expect(movedPiece.location.file).to.equal(expected.file);
        chai_1.expect(movedPiece.location.rank).to.equal(expected.rank);
        chai_1.expect(movedPiece.isWhite).to.equal(piece.isWhite);
        chai_1.expect(movedPiece.notation).to.equal(piece.notation);
    });
}

},{"../src/index":72,"chai":5}]},{},[73]);
